...
import tipcalculator.ui.theme.ComposeBasicsTheme
...
@Composable
fun EditNumberField(label: String, @DrawableRes leadingIcon: Int, keyboardOptions: KeyboardOptions, value: String, onValueChange: (String) -> Unit, modifier: Modifier = Modifier) {
    TextField(
        value = value,
